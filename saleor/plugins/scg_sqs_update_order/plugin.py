...
from .dataclasses import ScgSqsUpdateOrderConfig


class ScgSqsUpdateOrderPlugin(BasePlugin):
    PLUGIN_ID = PLUGIN_ID
    ...
    PLUGIN_NAME = "Scg SQS Update order"
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.config = ScgSqsUpdateOrderConfig(
